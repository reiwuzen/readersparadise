  ...
  return (
    <nav className="navbar">
      {/* {
        <div className={`navbarSideBar ${sideBar ? "open" : "closed"} `}>
          <ul className="navbarSideBarList">
            ...
            <li
              onClick={() => {
                (window as any).openTab("settings");
                setSideBar(!sideBar);
              }}
            >
              Settings
      ...
      <ul className="menubar">
        <li>
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" color="currentColor" className="menubarIcons tabler-icon" fill="currentColor" fill-rule="evenodd">
        ...
        <li>
          ...
          >
            ...
            <path d="M14 2a15.3 15.3 0 0 1 0 20" />
            <path d="M10 2a15.3 15.3 0 0 0 0 20" />
            <path d="M12 2a15.3 120.3 0 0 0 0 20" />
          </svg> */}
          {<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" color="currentColor" className="menubarIcons tabler-icon duration-100 group-hover:scale-110 text-foreground scale-110" fill="currentColor" fill-rule="evenodd">
