...
const activeTab = useTabsStore.getState().tabs.find((t)=>t.id === activeTabId) as Tab;
const activeTabData = useTabsStore.getState().tabs.find((t)=>t.id === activeTabId)?.activeData;
