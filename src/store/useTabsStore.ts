...
// import { SearchResult } from "./useDiscoverStore";
...
// export type TabData<T extends TabType = TabType> = {
//   name: string;
//   type: T;
//   url: string;
//   data: T extends keyof TabDataMap ? TabDataMap[T] : Record<string, unknown>;
// };
